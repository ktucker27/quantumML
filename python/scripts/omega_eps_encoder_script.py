...
def main():
    ...
    for run_idx in range(start_run_idx, start_run_idx + num_runs, 1):
      ...
      for train_idx in range(num_training_runs):
        ...
        run_history = enc_model.fit(train_x, train_params, batch_size=mini_batch_size, epochs=num_epochs[train_idx],
                                validation_data=(valid_x, valid_params), verbose=verbose_level, shuffle=True,
      ...
      if savemodel:
        ...
        fusion.save_model(enc_model, savepath)
