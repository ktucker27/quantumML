function [a, b, c, w, u, lloc_evs, norms] = nqs_open_learn(a, b, c, w, u, lloc, density, eta, num_iterations, num_samps, num_steps, L)
...
lloc_evs = zeros(num_iterations,1);
for i=1:num_iterations
    ...
    if size(L,1) > 0
        [~,~,~,rho_vec] = nqs_density_mat(density, a, b, c, w, u);
        norms(i,1) = norm(L*rho_vec);
    end
    
    [S,F,lloc_evs(i,1)] = nqs_open_sf(a, b, c, w, u, lloc, density, num_samps, num_steps);
